...
# ── USER SETTINGS ─────────────────────────────────────────────────────────────
dataset = 'test'                               # subfolder in output_3d
...
mesh_file   = base_dir / dataset / "smoothed_all_meshes.npy"     # (F, V, 3)
faces_file  = base_dir / "smplx_faces.npy"             # (F_faces, 3)
joints_file = base_dir / dataset / "smoothed_all_joints.npy"   # (F, n_joints, 3)
